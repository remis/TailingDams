...
path_upwards = '../'
path_to_images = path_upwards + config.data_path + config.train_updated_dam_image_path
...
for file in os.listdir(path_to_images):
    img_array = np.transpose(np.array(gdal.Open(path_to_images + file).ReadAsArray()),
                             axes=(1, 2, 0))
...
# min width 95, min height 95, number of images 855
