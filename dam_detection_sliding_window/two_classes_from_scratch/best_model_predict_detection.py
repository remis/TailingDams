...
for file in os.listdir(path_to_test_images):
    ...
    pred_boxes, pred_probs = apply_for_sliding_window(model, image, patch_size=(patch_width, patch_height), stride=118,
                                                      batch_size=8, normalise_pathces=True, image_mean=image_mean,
                                                      image_std=image_std)
